...
public record TorznabCaps
{
    ...
    [XmlElement("server")]
    public TorznabServer? Server { get; init; }

    [XmlElement("limits")]
    public TorznabLimits? Limits { get; init; }

    [XmlElement("retention")]
    public TorznabRetention? Retention { get; init; }

    [XmlElement("registration")]
    public TorznabRegistration? Registration { get; init; }

    [XmlElement("searching")]
    public TorznabSearching? Searching { get; init; }
